...
public final class Constants {
  ...
  public static class LauncherConstants {
    ...
    public static final int kArmRightCurrentLimit = 60;
    public static final int kArmLeftCurrentLimit = 60;

    // Speeds for wheels when intaking and launching. Intake speeds are negative to run the wheels
    // in reverse
    public static final double kLauncherSpeed = -1.0;
    public static final double kLaunchFeederSpeed = -1;
    public static final double kPusherSpeed = -.25;
    public static final double kPushFeederSpeed = -.45;
